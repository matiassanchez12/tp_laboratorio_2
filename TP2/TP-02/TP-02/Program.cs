...
namespace TP_02_2018
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            //NOTA: (El segundo cliclomotor que se trata de quitar no existe, c1 es quitado con exito)
            taller -= c1;
            ...
            // Vuelvo a agregar c2. 
            // NOTA: (cd2 nunca fue quitado, por lo tanto no se agrega porque ya existe)
            taller += c2;
