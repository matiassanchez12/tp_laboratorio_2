...
namespace WindowsForms
{
    public static class Input
    {
        ...
        /// </summary>
        /// <param name="title">titulo del cuadro</param>
        /// <param name="promptText">descripcion del cuadro</param>
        /// <param name="value">lugar donde se guardaran los datos introducidos</param>
        /// <returns>Devuelve el dato de tipo enum "OK" o "CANCEL"</returns>
